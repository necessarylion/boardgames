...
export const myCoup = {
  ...
  'home.coup.hostHint': 'ကူးတွင် ဆက်တင်များ မရှိပါ — အခန်းဖန်တီးပြီး ကတ်ဝေလိုက်ရုံသာ။',
  ...
  'coup.dice.title': 'ပထမဆုံးစမည့်သူအတွက် အန်စာလှိမ့်နေသည်',
  'coup.dice.tieRound': 'သရေဖြစ်၍ ထပ်လှိမ့်သည် (အကြိမ် {n})',
  'coup.dice.rolling': 'လှိမ့်နေသည်…',
  'coup.dice.winner': '{name} စတင်သည်',
  'coup.dice.skip': 'ကျော်ရန်',
  ...
  'coup.event.challengeLost': '{name} စိန်ခေါ်ရာ မှားယွင်းသည် — {target} တွင် {character} ရှိသည်။',
  ...
  'coup.rules.challenge.wrong':
    'စိန်ခေါ်မှု မှားလျှင် — သင် ဩဇာတစ်ခု စွန့်ရမည်။ ထိုသူက ကတ်ကိုပြပြီး ကတ်ထုပ်သို့ ပြန်ထည့်ကာ အသစ်တစ်ခု ယူသည်။',
